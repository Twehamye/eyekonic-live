# Generated by Django 4.1.2 on 2023-09-08 12:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('member', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eyekonic_app.member')),
            ],
        ),
        migrations.CreateModel(
            name='FinePayment',
            fields=[
                ...
                ('fine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eyekonic_app.fine')),
            ],
        ),
        migrations.AddField(
            model_name='fine',
            name='member',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='eyekonic_app.member'),
        ),
        migrations.CreateModel(
            name='Expense',
            fields=[
                ...
                ('member_responsible', models.ForeignKey(default=None, on_delete=django.db.models.deletion.SET_DEFAULT, to='eyekonic_app.member')),
            ],
        ),
        migrations.CreateModel(
            name='Deposit',
